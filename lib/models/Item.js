...
module.exports = class Item {
  ...
  static async updateById(id, attrs) {
    ...
    const {
      rows
    } = await pool.query('UPDATE items SET title=$2 , description=$3, buy=$4, rent=$5, borrow=$6, price=$7, zipcode=$8, sold=$9 WHERE id= $1', [id, title, description, buy, rent, borrow, price, zipcode, sold]);
